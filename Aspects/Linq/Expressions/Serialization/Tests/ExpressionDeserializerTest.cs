...
namespace vm.Aspects.Linq.Expressions.Serialization.Tests
{
    ...
    public class ExpressionDeserializerTest
    {
        ...
        void Test(Expression expected, string fileName, bool notUsed = false)
        {
            ...
            var expression = Expression.Block(
                                ...
                                Expression.Call(
                                    typeof(Console).GetMethod(
                                                        ...
                                                        new Expression[] { Expression.Constant("GoTo") }),
                                Expression.MakeGoto(GotoExpressionKind.Goto, returnTarget, null, typeof(void)),
                                Expression.Call(
                                    typeof(Console).GetMethod(
                                                        "WriteLine",
                                                        new Type[] { typeof(string) }),
                                                        new Expression[] { Expression.Constant("Other Work") }),
            ...
            var expression = Expression.Block(
                                ...
                                Expression.Call(
                                    typeof(Console).GetMethod(
                                                        ...
                                                        new Type[] { typeof(string) }),
                                                        new Expression[] { Expression.Constant("GoTo") }),
                                Expression.MakeGoto(GotoExpressionKind.Goto, returnTarget, null, null),
                                Expression.Call(
                                    typeof(Console).GetMethod(
                                                        "WriteLine",
                                                        new Type[] { typeof(string) }),
