...
namespace vm.Aspects.Model
{
    /// <summary>
    /// <para>
    /// Interface IHasBusinessKey requires implementing a property <see cref="P:Key"/> in the implementing types 
    ...
    /// <see cref="P:Key"/> and also the .NET rules of equality are also implemented based on the value of 
    /// <see cref="P:Key"/>.
    /// </para>
    /// </summary>
