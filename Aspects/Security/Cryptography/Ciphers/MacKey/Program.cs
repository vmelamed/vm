...
namespace vm.Aspects.Security.Cryptography.Ciphers.Utilities
{
    class Program
    {
        ...
        {
            Contract.Requires<ArgumentNullException>(argument!=null, nameof(argument));
            Contract.Requires<ArgumentException>(!string.IsNullOrWhiteSpace(argument), "The argument "+nameof(argument)+" cannot be empty or consist of whitespace characters only.");
