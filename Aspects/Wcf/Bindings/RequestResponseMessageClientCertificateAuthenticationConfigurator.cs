...
namespace vm.Aspects.Wcf.Bindings
{
    ...
    public class RequestResponseMessageClientCertificateAuthenticationConfigurator : RequestResponseMessageConfiguratorBase
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RequestResponseMessageClientCertificateAuthenticationConfigurator"/> class.
        /// </summary>
        /// <param name="config">The configuration.</param>
        public RequestResponseMessageClientCertificateAuthenticationConfigurator(
