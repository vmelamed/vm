...
{
    /// <summary>
    /// Class RequestResponseBasicAuthenticationConfigurator. Configures the bindings for request-response messaging pattern with basic authentication. 
    /// </summary>
    public class RequestResponseBasicAuthenticationConfigurator : RequestResponseNoSecurityConfigurator
    {
        /// <summary>
        /// The pattern name
        /// </summary>
        public new const string PatternName = "RequestResponseBasicAuthentication";
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RequestResponseBasicAuthenticationConfigurator"/> class.
        /// </summary>
        /// <param name="config">The configuration.</param>
        public RequestResponseBasicAuthenticationConfigurator(
