...
namespace vm.Aspects.Wcf.Bindings
{
    ...
    /// </summary>
    public class FireAndForgetConfigurator : RequestResponseConfigurator
    {
        /// <summary>
        /// The pattern name
        /// </summary>
        public new const string PatternName = "FireAndForget";
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="FireAndForgetConfigurator"/> class.
        /// </summary>
        /// <param name="config">The configuration.</param>
        public FireAndForgetConfigurator(
            ...
            NetMsmqBinding binding)
        {
            ...
            // TODO: turn security mode off for now:
